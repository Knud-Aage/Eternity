    ...
    private boolean isInternallyValid(int[] candidates, int base) {
        for (int r = 0; r < 4; r++) {
            for (int c = 0; c < 3; c++) {
                ...
                if (PieceUtils.getEast(candidates[leftIdx]) != PieceUtils.getWest(candidates[rightIdx])) {
                    return false;
                }
            }
        }
        ...
        for (int c = 0; c < 4; c++) {
            for (int r = 0; r < 3; r++) {
                ...
                if (PieceUtils.getSouth(candidates[topIdx]) != PieceUtils.getNorth(candidates[bottomIdx])) {
                    return false;
                }
            }
        }
